...
frame = frame.rename(index=str, columns={" pickup_longitude": "Pickup_longitude", " pickup_latitude": "Pickup_latitude"})
print(frame)

frame2 = frame2[frame2['Pickup_longitude'] != 0]
frame2 = frame2[frame2['Pickup_latitude'] != 0]
frame2 = frame2[frame2['Pickup_longitude'] <= -73.5]
frame2 = frame2[frame2['Pickup_longitude'] >= -74.2]
frame2 = frame2[frame2['Pickup_latitude'] <= 41.2]
frame2 = frame2[frame2['Pickup_latitude'] >= 40.5]


frame = frame[frame['Pickup_longitude'] != 0]
frame = frame[frame['Pickup_latitude'] != 0]
frame = frame[frame['Pickup_longitude'] <= -73.5]
frame = frame[frame['Pickup_longitude'] >= -74.2]
frame = frame[frame['Pickup_latitude'] <= 41.2]
frame = frame[frame['Pickup_latitude'] >= 40.5]

result = pd.concat([frame2[["Pickup_longitude", "Pickup_latitude"]],frame[["Pickup_longitude", "Pickup_latitude"]]]) 
print(result)
